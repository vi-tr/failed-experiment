...
class RoleGive(commands.Cog):
    ...
    async def give_role(self,
                    ...
                    id_name : str,
                    role : str):
        # Это хрень возвращает либо роль, либо ничего, пожтому трай/експект тут не катит
        ...
        if member == None:
            ...
            if choice.pop()==1:
                ...
                return
            try:
                # А вот эта хрень уже может выдать ошибку. Так как бот не может присвоить роль выше своей (ну типо)
